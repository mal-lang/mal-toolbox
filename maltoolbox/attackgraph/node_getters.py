...
def get_similar_full_names(full_name_to_node: dict[str, AttackGraphNode], q: str):
    shortest_dist = 100
    similar_names = []
...
def get_node_by_full_name(
    full_name_to_node: dict[str, AttackGraphNode], full_name: str
):
