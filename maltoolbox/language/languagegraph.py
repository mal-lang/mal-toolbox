...
class LanguageGraph():
    ...
    def __init__(self, lang: dict, with_extra_deepcopy):
        self.assets: list = []
    ...
    @classmethod
    def from_mar_archive(cls, mar_archive: str, with_extra_deepcopy) -> LanguageGraph:
        """
    ...
    def _get_attacks_for_asset_type(self, asset_type: str, with_extra_deepcopy) -> dict:
        """
