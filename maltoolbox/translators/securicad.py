...
def load_model_from_scad_archive(
    ...
    for child in root.iter('associations'):
        ...
        for assoc in left_asset.lg_asset.associations:
            if (
                assoc.left_field.fieldname == left_field
                and assoc.right_field.fieldname == right_field
            ) or (
                assoc.left_field.fieldname == right_field
                and assoc.right_field.fieldname == left_field
            ):
