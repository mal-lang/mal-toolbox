...
def test_attackgraph_save_load_no_model_given_without_attackers(
    ...
    attackgraph_save_load_no_model_given(
        example_attackgraph, corelang_lang_graph, False
    )
...
def test_attackgraph_save_load_no_model_given_with_attackers(
    ...
    attackgraph_save_load_no_model_given(example_attackgraph, corelang_lang_graph, True)
...
def test_attackgraph_save_and_load_json_yml_model_given_with_attackers(
    ...
    attackgraph_save_and_load_json_yml_model_given(
        example_attackgraph, corelang_lang_graph, True
    )
...
def test_attackgraph_subtype() -> None:
    ...
    # Create assets
    baseasset1 = lang_classes_factory.get_asset_class('BaseAsset')(name='BaseAsset 1')

    subasset1 = lang_classes_factory.get_asset_class('SubAsset')(name='SubAsset 1')
...
def test_attackgraph_setops() -> None:
...
def test_attackgraph_transitive() -> None:
    test_lang_graph = LanguageGraph(
    ...
    asset1 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 1')
    asset2 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 2')
    asset3 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 3')
    asset4 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 4')
    asset5 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 5')
    asset6 = lang_classes_factory.get_asset_class('TestAsset')(name='TestAsset 6')
...
def test_attackgraph_transitive_advanced() -> None:
