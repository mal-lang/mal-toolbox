...
def test_dynamic_model():
    ...
    infected_device = model.add_asset(asset_type="Device", name="InfectedDevice", asset_id=3)
    ...
    vulnerable_device = model.add_asset(asset_type="Device", name="VulnerableDevice", asset_id=6)
    vulnerable_device.add_associated_assets(fieldname="receiveFrom", assets={infected_device})
    vulnerable_device.add_associated_assets(fieldname="sendTo", assets={infected_device})

    internet = model.add_asset(asset_type="Internet", name="Internet", asset_id=1)
    internet.add_associated_assets(fieldname="hosts", assets={c2server, infected_device, vulnerable_device})
