...
def test_render_attack_graph_to_exact_file(
    example_attackgraph: AttackGraph, tmp_path: Path
):
...
def test_render_attack_graph_no_path(
    example_attackgraph: AttackGraph, tmp_path: Path, monkeypatch
):
    """
